...
} from "../api/notification-adapter.js";
import { handleRequest, clientCatalog,
  panelCatalog,
  validateNotificationRequest,
  validateNotificationWorkflowCapabilities } from "../api/request-handler.mjs";
...
test("tracked notification adapter example is generic and structurally valid", () => {
  const example = JSON.parse(readFileSync(new URL("../config/notification-adapter.example.json", import.meta.url), "utf8"));
